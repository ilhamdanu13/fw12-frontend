                ...
                <div className="border-r-2 border-b-2 rounded-tr-xl rounded-br-xl">
                  ...
                  <div className=" justify-center flex pt-[50px]">
                    <div className="border-1 bg-[#F5F6F8]">
                      <div className="px-[36px] pt-[65px] pb-[55px] text-center font-bold">
                        <div className="text-[#14142B] text-[18px]">Ticket Already </div>
                        <div className="text-[#14142B] text-[18px]">Used</div>
                      </div>
                    </div>
                  </div>
                </div>

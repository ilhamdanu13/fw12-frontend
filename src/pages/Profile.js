          ...
          <div className="pt-3 lg:pt-[56px]">
            <div className="border-1 bg-white rounded-[16px] lg:w-[900px]">
              <div className="py-[25px] flex">
                <Link to="/profile" className="text-[18px] tracking-[.75] leading-[34px] text-[#14142B] mr-[56px] pl-3 lg:pl-[48px]">Account Settings</Link>
                  ...
                  <div className="text-[#4E4B66] text-[16px] pb-5 lg:pb-[64px] ">
                    <div className="lg:flex pl-3 lg:pl-[32px] pr-3 lg:pr-0 lg:mb-[32px]">
                      <div className=" lg:mr-[24px] relative mb-3 lg:mb-0">
                        ...
                        <label onClick={handleShowLeft} onKeyDown={handleShowLeft} className="absolute right-6 top-12 cursor-pointer">
                      ...
                      <div className="relative">
                        ...
                        <label onClick={handleShowRight} onKeyDown={handleShowRight} className="absolute right-6 top-12 cursor-pointer">

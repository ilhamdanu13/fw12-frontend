  ...
  return (
    <footer className="lg:flex px-3 lg:px-[136px]">
      <div className="pt-5 lg:pt-[110px] flex-1 ">
        ...
        <div className=" lg:pt-[30px] text-[16px] text-[#6E7191] mb-[5px]">Stop waiting in line. Buy tickets</div>
        <div className="text-[16px] text-[#6E7191]">conveniently, watch movies quietly.</div>
      </div>
      <div className="pt-5 lg:pt-[110px] lg:pl-[80px] flex-1 flex flex-col">
        <div className="text-[16px] mb-5 lg:mb-[30px] font-bold">Explore</div>
        <Link to="/homepage" className="mb-5">
          Home
        </Link>
        <Link to="/all">List Movie</Link>
      </div>
      <div className="pt-5 lg:pt-[110px] text-[16px] mb-[30px] font-bold flex-1">
